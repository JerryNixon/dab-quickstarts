...
//             dab.js (fetchTodos, createTodo, toggleTodo, deleteTodo, fetchWhoAmI)
...
async function updateIdentity() {
    ...
    const value = document.getElementById('sqlIdentity');
    const userInfo = document.getElementById('userInfo');
...
async function initializeApp() {
    await initAuth();
    updateUI();
    await Promise.all([loadTodos(), updateIdentity()]);
}
