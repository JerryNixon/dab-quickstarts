...
# ── 6. Generate config.js and deploy web files ──
...
# ── 7. Update web container app with custom image ──
...
"@
$localConfigContent | Out-File -FilePath "web/config.js" -Encoding utf8 -Force
