...
resource rg 'Microsoft.Resources/resourceGroups@2024-03-01' = {
  name: 'rg-quickstart5-${effectiveToken}'
  location: location
  tags: tags
}
...
output AZURE_WEB_APP_FQDN string = resources.outputs.webAppFqdn
output AZURE_WEB_APP_URL string = 'https://${resources.outputs.webAppFqdn}'
